...
import { Search, Plus, Edit, Trash2, Mail, Phone, MapPin, ExternalLink, X, Save, Users } from 'lucide-react';
type Supplier = {
  id: string;
  companyName: string;
...
const MOCK_SUPPLIERS: Supplier[] = [{
  ...
  email: 'logistics@megacorp.com',
  phone: '+1 (555) 987-6543',
  address: '456 Enterprise Blvd, NY',
  status: 'Active'
}, {
  id: '3',
  companyName: 'NanoChip Solutions',
  contactPerson: 'Dr. Wu',
  email: 'wu@nanochip.io',
  phone: '+86 21 5555 1234',
  address: '789 Silicon Valley Rd, Shenzhen',
  status: 'Inactive'
}];
              ...
              <div className="flex justify-between items-start mb-4">
                <div>
                  ...
                  <div className="flex items-center gap-2 mt-1">
                    <span className={`w-2 h-2 rounded-full ${supplier.status === 'Active' ? 'bg-accent-green' : 'bg-text-muted'}`}></span>
