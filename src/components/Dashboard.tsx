...
export function Dashboard() {
  ...
  return <div className="p-6 h-full overflow-y-auto bg-primary text-text-primary">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 mb-6">
        <MetricCard title="Total Inventory Value" value="$1,245,890" trend={12.5} chartData={chartData1} type="positive" />
        <MetricCard title="Low Stock Alerts" value="24" trend={-5.2} trendLabel="items critical" chartData={chartData2} type="negative" />
        <MetricCard title="Active SKUs" value="1,842" trend={3.8} chartData={chartData4} type="neutral" />
        <MetricCard title="Pending Orders" value="156" trend={0.0} trendLabel="awaiting fulfillment" chartData={chartData3} type="warning" />
      </div>
